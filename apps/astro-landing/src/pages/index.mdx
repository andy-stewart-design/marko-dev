...
<div class="install-block">
  ...
  <div>
    <span class="prompt">$</span>
    <span>npx astro add astro-marko</span>
  </div>
</div>
...
Importing `.marko` files in `.astro` or `.ts` files is typed automatically via an ambient `*.marko` module declaration injected into your project. For full per-component `Input` type inference, see the [Typed props](#typed-props) section above.
